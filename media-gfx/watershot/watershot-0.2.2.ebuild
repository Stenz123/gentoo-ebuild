...
SRC_URI="
	https://github.com/Kirottu/${PN}/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"

LICENSE="0BSD Apache-2.0 Apache-2.0-with-LLVM-exceptions BSD-2 Boost-1.0 CC0-1.0 GPL-3+ ISC MIT Unicode-DFS-2016 Unlicense ZLIB"
SLOT="0"
KEYWORDS="~amd64"

DEPEND="gui-apps/grim media-libs/fontconfig virtual/pkgconfig x11-libs/libxkbcommon"
RDEPEND="${DEPEND}"
BDEPEND=""
